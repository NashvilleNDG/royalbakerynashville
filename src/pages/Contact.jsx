    ...
    <div>
      <PageSEO
        ...
        schema={{
          ...
          "description": "Get a free quote or consultation from Royal Bakery Nashville.",
                ...
                <div className="bg-card rounded-2xl border border-border/50 p-8 sm:p-10 shadow-sm">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Full Name *</Label>
                      ...
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Email Address *</Label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Phone Number</Label>
                      ...
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Order Type *</Label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Number of Guests / Servings</Label>
                      ...
                      <div>
                        <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Needed By Date</Label>
                    ...
                    <div>
                      <Label className="font-body text-xs uppercase tracking-wide text-muted-foreground">Tell Us About Your Order</Label>
